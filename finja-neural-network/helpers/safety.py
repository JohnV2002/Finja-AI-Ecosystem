"""
YourAI AI - Safety Nodes
========================
Granite Guardian (Safety Filter) und Password Scanner.

Password Override Phrases werden aus .env geladen:
    ALTPERSONA_OVERRIDE_PHRASES=altpersona free,altpersona frei
...
# Default Override-Phrases (Fallback wenn .env nicht gesetzt)
...
def granite_guardian_node(state, debug: Any = None) -> Dict[str, Any]:
    ...
    Sonst prüft ob die Anfrage sicher ist.
    ...
    # ==========================================
    # GRANITE BYPASS (Ermöglicht Erziehen!)
    # ==========================================
    if not USE_GRANITE:
...
def password_scanner_node(state, debug: Any = None) -> Dict[str, Any]:
    ...
    Prüft ob der User eine Override-Phrase verwendet hat.
    ...
    # Check für Override-Phrases aus .env
