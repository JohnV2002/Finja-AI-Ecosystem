...
def _load() -> dict:
    try:
        ...
        log_exception("TTS-LIMIT", YourAISystemError("Fehler beim Laden von tts_usage.json", cause=e))
    return {}
...
def _save(data: dict):
    try:
        ...
        log_exception("TTS-LIMIT", YourAISystemError("Fehler beim Speichern von tts_usage.json", cause=e))
